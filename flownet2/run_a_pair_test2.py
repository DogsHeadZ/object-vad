...
if __name__ == '__main__':
    ...
    img1 = '/data1/feihuqaq/AllDatasets/ped2/testing/frames/01/108.jpg'
    img2 = '/data1/feihuqaq/AllDatasets/ped2/testing/frames/01/109.jpg'
    ...
    # plt.show()
    print('11')
    plt.imsave('data/avenue1.png', img)
    plt.imsave('data/avenue2.png', img2)
