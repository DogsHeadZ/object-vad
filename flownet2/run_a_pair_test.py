...
if __name__ == '__main__':
    ...
    pim1 = cv2.imread("data/chairs/0img0.ppm")
    pim1 = cv2.resize(pim1, (384, 512))
    transform = transforms.Compose([
        transforms.ToTensor(),
    ])
    pim1 = transform(pim1).unsqueeze(dim=0).cuda()

    pim2 = cv2.imread("data/chairs/0img1.ppm")
    pim2 = cv2.resize(pim2, (384, 512))
    transform = transforms.Compose([
        transforms.ToTensor(),
    ])
    ...
    # plt.show()
    print('11')
    plt.imsave('data/chairs/test-img2.png', img)
