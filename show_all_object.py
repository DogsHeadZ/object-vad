...
if __name__ == "__main__":
    ...
    #     os.makedirs(os.path.join(save_dir, "abnormal"))
    #     os.makedirs(os.path.join(save_dir, "frame"))
    #
    # dataset = "/data1/feihuqaq/AllDatasets/ped2/testing/frames/"
    ...
    #             #         abnormal_frame = img
    #
    #         path = os.path.join(save_dir, "frame", "ped2_"+ str(videos[index]) + "_" + str(i)+".jpg")
    ...
    if not os.path.exists(save_dir):
        ...
        os.makedirs(os.path.join(save_dir, "abnormal"))
        os.makedirs(os.path.join(save_dir, "frame"))
    dataset = "/data1/feihuqaq/AllDatasets/avenue/testing/frames/"
    videos = sorted(os.listdir(dataset))
        ...
        for i in range( len(frame_list)-4 ): #滑窗长度为5
            ...
            for bbox in roi:
                ...
                try:
                    ...
                    frames = img
            total_frame = flow_utils.flow2img(frame_flows[i].cpu().numpy().transpose(1, 2, 0))
            path_frame = os.path.join(save_dir, "frame", "avenue_frame_"+ str(videos[index]) + "_" + str(i)+".jpg")
            cv2.imwrite(path_frame, total_frame)
            path = os.path.join(save_dir, "frame", "avenue_"+ str(videos[index]) + "_" + str(i)+".jpg")
            cv2.imwrite(path, frames)
